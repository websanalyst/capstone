...
Partial Class _Default
    ...
    Protected Sub ButtonNext1_Click(sender As Object, e As EventArgs) Handles ButtonNext1.Click
        ...
        Select campusselect.SelectedValue
  ...
  End Sub
  Protected Sub ButtonNext3_Click(sender As Object, e As EventArgs) Handles ButtonNext3.Click

    'NE_0927; adding code here

    'DT_1006; corrected the code to display the department name from the dropdown
    LabelDept.Text = DropDownList2.SelectedItem.Text
    PanelServiceCoral.Visible = False
    DropDownList2.Visible = False
    ddlQuestions.Visible = False
    QuestionIds = QuestionIds + "2,"
    AnswerIDs = AnswerIDs + DropDownList2.SelectedItem.Text + ","
    ' MsgBox(AnswerIDs + "<Aid -- Qid>" + QuestionIds) 'DEBUG code
    myQuLabel1.Text = "questions go here"
  ...
  End Sub
    ...
    sql = "sp_GetQuestionsbyCat " + DropDownList1.SelectedValue 'Or "sp_GetQuestionsbyCat" + DropDownList2.SelectedValue
  ...
  Protected Sub GetCat2_Selecting(sender As Object, e As SqlDataSourceSelectingEventArgs) Handles GetCat2.Selecting
