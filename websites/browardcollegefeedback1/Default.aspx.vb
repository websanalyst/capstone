...
' CIS4596; Group 1 Project

' Default Class for the Project
Partial Class _Default
    Inherits Page

    Dim QuestionIds As String
    Dim AnswerIDs As String
    'This string is for saving the dapartment ID being rated
    ...
    Protected Sub ButtonNext2_Click(sender As Object, e As EventArgs) Handles ButtonNext2.Click
        ...
        'Display the department name from the dropdown
    ...
    Protected Sub ButtonCont_Click(sender As Object, e As EventArgs) Handles ButtonCont.Click
        'Now that we have the questions we have to figure out which panel to display, 
    ...
    ' CIS4596 - Check if this rutine will be used - If not delete -
    ...
    'This should be the last panel after all the questions are answered and the user is ready to submit the form
    'This panel is no longer used, can be commented out.
    ...
    'This sub adds Yes/No answers to the answer form.
    ...
    'This sub adds Ratings answers to the answer form.
    Protected Sub ButtodnSubmitRat_Click(sender As Object, e As EventArgs) Handles ButtonSubmitRat.Click
        PanelAdmissions.Visible = False
        PanelRatings.Visible = True
    ...
    'This sub adds Comments answers to the answer form.
    ...
    Public Sub ButtonGoBack_Click(sender As Object, e As EventArgs) Handles ButtonGoBack.Click
        'Added this SUB for the start over code.
        PanelContinue.Visible = False
        'Clearr Question and answer strings
        QuestionIds = ""
        AnswerIDs = ""
        'Turn on ddl and panel
        DropDownList1.Visible = True
        ddlQuestions.Visible = True
        PanelCampus.Visible = True
        'Clear campus select button
